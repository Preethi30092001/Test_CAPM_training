using { preethi.db.master, preethi.db.transaction } from '../db/datamodel';
...
service CatalogService @(path: 'CatalogService') {
    ...
    entity POs @(odata.draft.enabled: true,Common.DefaultValuesFunction: 'getOrderDefault') as projection on transaction.purchaseorder{
        *,
        case OVERALL_STATUS
          when 'N' then 'New'
          when 'P' then 'Pending'
